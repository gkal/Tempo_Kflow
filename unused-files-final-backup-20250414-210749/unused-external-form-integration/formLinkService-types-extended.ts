...
/**
 * Cross-project verification request
 */
export interface CrossProjectVerificationRequest {
  token: string;
  projectApiKey: string;
}

/**
 * Cross-project verification response
 */
export interface CrossProjectVerificationResponse {
  success: boolean;
  data?: {
    isValid: boolean;
    formLink?: Omit<CustomerFormLink, 'token'>;
    customer?: Partial<Database['public']['Tables']['customers']['Row']>;
  };
  error?: string;
}
