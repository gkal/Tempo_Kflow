 ...
 */
export function logDebug(message: string, data?: any, additionalData?: any): void {
  ...
  if (logConfig.enableConsole) {
    if (additionalData !== undefined) {
      console.log(`🔍 DEBUG: ${message}`, data !== undefined ? data : '', additionalData);
    } else {
 ...
 */
export function logInfo(message: string, data?: any, additionalData?: any): void {
  ...
  if (logConfig.enableConsole) {
    if (additionalData !== undefined) {
      console.info(`ℹ️ INFO: ${message}`, data !== undefined ? data : '', additionalData);
    } else {
 ...
 * - Performance issues
 */
export function logWarning(message: string, data?: any, additionalData?: any): void {
  ...
  if (logConfig.enableConsole) {
    if (additionalData !== undefined) {
      console.warn(`⚠️ WARNING: ${message}`, data !== undefined ? data : '', additionalData);
    } else {
...
export interface Logger {
  debug: (message: string, data?: any, additionalData?: any) => void;
  info: (message: string, data?: any, additionalData?: any) => void;
  warning: (message: string, data?: any, additionalData?: any) => void;
  warn: (message: string, data?: any, additionalData?: any) => void;
  error: (message: string, data?: any, additionalData?: any) => void;
  getPrefixedMessage: (message: string) => string;
}

export function createPrefixedLogger(prefix: string): Logger {
  const getPrefixedMessage = (message: string) => `[${prefix}] ${message}`;
  
  return {
    debug: (message: string, data?: any, additionalData?: any) => {
      logDebug(getPrefixedMessage(message), data, additionalData);
    },
    info: (message: string, data?: any, additionalData?: any) => {
      logInfo(getPrefixedMessage(message), data, additionalData);
    },
    warning: (message: string, data?: any, additionalData?: any) => {
      logWarning(getPrefixedMessage(message), data, additionalData);
    },
    warn: (message: string, data?: any, additionalData?: any) => {
      logWarning(getPrefixedMessage(message), data, additionalData);
    },
    error: (message: string, data?: any, additionalData?: any) => {
      logError(getPrefixedMessage(message), data, additionalData);
    },
    getPrefixedMessage
  };
}
