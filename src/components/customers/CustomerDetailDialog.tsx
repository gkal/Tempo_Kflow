...
import { Loader2, User, Calendar, Clock, Archive, Phone, FileText, CheckCircle, AlertTriangle } from 'lucide-react';
...
export function CustomerDetailDialog({
  ...
  return (
    <DialogWrapper
      ...
      className="max-w-3xl bg-[#2f3e46] border-[#52796f] text-[#cad2c5]"
      contentProps={{
        className: "max-w-3xl bg-[#2f3e46] border-[#52796f] text-[#cad2c5]"
      }}
    >
