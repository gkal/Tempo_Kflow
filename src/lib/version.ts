...
export const VERSION_HISTORY: VersionEntry[] = [
  {
    ...
    description: "Βελτιώσεις Εντοπισμού Διπλοεγγραφών Πελατών",
    changes: [
      "Εφαρμογή αλγορίθμου ασαφούς αντιστοίχισης συμβολοσειρών με fuzzball.js",
      "Προσθήκη συστήματος βαθμολόγησης με βάρη (30% όνομα εταιρείας, 20% τηλέφωνο, 50% ΑΦΜ)",
      "Βελτίωση διεπαφής χρήστη με χρωματικούς κώδικες για αντιστοιχίσεις (κίτρινο: 75-80%, κόκκινο: >80%)",
      "Αναπτυγμένες λεπτομέρειες πελατών στα αποτελέσματα αντιστοίχισης",
      "Κατάλληλος χειρισμός Ελληνικών χαρακτήρων με τόνους στην αναζήτηση",
      "Συμπερίληψη διαγραμμένων/αρχειοθετημένων πελατών στην αναζήτηση με οπτική ένδειξη"
    ]
  },
  {
    version: "1.5.3",
    date: formatReleaseDate(new Date(Date.now() - 2 * 24 * 60 * 60 * 1000)), // 2 days ago
