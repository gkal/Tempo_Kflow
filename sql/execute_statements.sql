-- This file contains the same statements as ensure_soft_delete_columns.sql
-- but formatted for easier execution in any SQL client.
-- You can copy and paste these commands directly into your SQL query tool.
...
-- ===============================
-- Create history tables for audit logging
-- ===============================
